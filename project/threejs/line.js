...
var count = -100;
var streakline;
var startx = 10, starty = 1, startz = -100;
var posx,posy,posz;
var streakgeometry,streakmaterial;
...
function animate()
{
    ...
    scene.remove(streakline);

    streakgeometry = new THREE.Geometry();
    streakgeometry.vertices.push(new THREE.Vector3(startx, starty, startz));
    streakgeometry.vertices.push(new THREE.Vector3(posx, posy, posz));
    streakline = new THREE.Line(streakgeometry, streakmaterial);
